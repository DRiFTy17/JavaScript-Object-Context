/**
 * An AngularJS domain context/change tracking module.
 * 
...
angular.module('ngDomainContext', []).provider('domainContext', function() {
    ...
    /**
     * This is the endpoint that is used when sending load/invoke/submit requests 
     * to the server.
     */
    ...
    this.$get = ['$rootScope', '$q', '$http', function($rootScope, $q, $http) {
        ...
        return {
            /**
             * Creates a new DomainContext instance. If true is passed, then a $digest
            ...
            create: function(evalOnDigest) {
                if (_isSingleton) {
                    _instance = _instance || new DomainContext($rootScope, $q, $http, evalOnDigest, _endpointUri);
                    return _instance;
                }

                return new DomainContext($rootScope, $q, $http, evalOnDigest, _endpointUri);
            },
            /**
             * Returns a DomainContext instance (if we are to set to be a singleton).
             * If an instance was not found, then we return null.
             */
 ...
 *   - isSubmitting
 */
function DomainContext(rootScope, q, http, evalOnDigest, uri) {
    var self = this;
    ...
    /**
     * The URI to request when executing load/invoke requests.
     */
    ...
    /**
     * This is a flag that can be queried and used to know if an async load/invoke operation
 ...
 */
DomainContext.prototype.setOnChangeListener = function(listener) {
 ...
 */
DomainContext.prototype.removeOnChangeListener = function(listener) {
 ...
 * property.
 */
DomainContext.prototype.add = function(obj) {
    var self = this;
 ...
 */
DomainContext.prototype.doesObjectExist = function(objectReference) {
 ...
 */
DomainContext.prototype.remove = function(obj, hardDelete) {
 ...
 */
DomainContext.prototype.removeAll = function(hardDelete) {
    this._objectMap = [];
}
 ...
 */
DomainContext.prototype._getMapIndex = function(obj) {
    for (var i = 0; i < this._objectMap.length; i++) {
 ...
 * is returned.
 */
DomainContext.prototype.getOriginal = function(objectReference) {
    for (var i = 0; i < this._objectMap.length; i++) {
        if (this._objectMap[i].current === objectReference) {
 ...
 */
DomainContext.prototype._getMappedObject = function(obj) {
 ...
 */
DomainContext.prototype.getObjectStatus = function(obj) {
    if (!obj)
        return null;
 ...
 */
DomainContext.prototype.evaluate = function() {
 ...
 */
DomainContext.prototype._evalObject = function(objectReference, obj, path) {
 ...
 */
DomainContext.prototype._evalArray = function(objectReference, ary, path) {
 ...
 */
DomainContext.prototype._checkForChanges = function(objectReference, property, path) {
 ...
 */
DomainContext.prototype.revert = function(obj) {
 ...
 */
DomainContext.prototype.revertAll = function() {
    for (var i = 0; i < this._objectMap.length; i++) {
 ...
 */
DomainContext.prototype.resetObject = function(obj) {
 ...
 */
DomainContext.prototype.revertProperties = function(item) {
 ...
 */
DomainContext.prototype.hasChanges = function() {
    for (var i = 0; i < this._objectMap.length; i++) {
 ...
 */
DomainContext.prototype.clear = function() {
    this._objectMap = [];
    this.changeListeners = [];
};
 ...
 */
DomainContext.prototype.getChangeset = function(obj) {
    var self = this;
    var changes = {};
...
/**
 * Submit the current changes in the context to the server.
 * 
 * Take the current object in each tracked object, and update its original value
 * and clear the changeset.
 */
DomainContext.prototype.submit = function() {
 ...
 */
DomainContext.prototype.setAutoEvaluate = function(canEval) {
    var self = this;
...
/**
 * Attempts to load the requested type into the context by sending a request
 * to the server for that type, along with query parameters.
 */
DomainContext.prototype.load = function() {
    var self = this;
 ...
 */
DomainContext.prototype.getObjects = function() {
    var objects = [];
 ...
 */
DomainContext.prototype.getObjectsByType = function(requestedType) {
    var objects = [];
 ...
 */
DomainContext.prototype.stringFormat = function() {
    var s = arguments[0];
