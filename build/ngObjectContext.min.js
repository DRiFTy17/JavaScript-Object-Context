angular.module("ngObjectContext",[]).provider("objectContext",function(){var a=!0,b=null;this.allowMultipleInstances=function(b){a=!b};this.$get=["$rootScope",function(c){var d=[];return{create:function(e){e="undefined"!==typeof e?!!e:!0;if(a)b||(b=new ObjectContext,e&&d.push({contextInstance:b,deregisterWatchFn:c.$watch(function(){b.evaluate()})}));else{var f=new ObjectContext;e&&d.push({contextInstance:f,deregisterWatchFn:c.$watch(function(){b.evaluate()})});return f}return b},getInstance:function(a){return b||
this.create("undefined"!==typeof a?!!a:!0)},stopAutoWatch:function(a){for(var b=d.length-1;0<=b;b--)d[b].contextInstance===a&&d[b].deregisterWatchFn&&(d[b].deregisterWatchFn(),d.splice(b,1))},startAutoWatch:function(a){if(!a)throw Error("Invalid context instance specified.");for(var b=!1,g=0;g<d.length;g++)d[g].contextInstance===a&&(b=!0);!b&&a.evaluate&&d.push({contextInstance:a,deregisterWatchFn:c.$watch(function(){a.evaluate()})})}}}]});"use strict";
